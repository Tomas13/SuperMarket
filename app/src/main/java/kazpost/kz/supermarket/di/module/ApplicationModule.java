...
import kazpost.kz.supermarket.data.AppDataManager;
import kazpost.kz.supermarket.data.DataManager;
import kazpost.kz.supermarket.data.network.ApiHelper;
import kazpost.kz.supermarket.data.network.AppApiHelper;
import kazpost.kz.supermarket.data.network.NetworkService;
import kazpost.kz.supermarket.data.prefs.AppPreferencesHelper;
import kazpost.kz.supermarket.data.prefs.PreferencesHelper;
import kazpost.kz.supermarket.di.ApplicationContext;
import kazpost.kz.supermarket.di.PreferenceInfo;
import kazpost.kz.supermarket.utils.AppConstants;
...
import static kazpost.kz.supermarket.utils.AppConstants.BASE_URL;
